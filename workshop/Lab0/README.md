...
1. As a prerequisite for the IBM Cloud Container Service plug-in, install the [IBM Cloud command-line interface](https://console.bluemix.net/docs/cli/index.html). Once installed, you can access IBM Cloud from your command-line with the prefix `bx`.
